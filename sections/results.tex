...
% raw trajectories
  %Tables noting the trajectories of positions of the pigeons' heads, their angles, and the position of the bodies along the x-axis for each experiment are in the Appendix.
