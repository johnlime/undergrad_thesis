...
In our research, we construct a simplified model of pigeons that represent their heads, necks, and bodies and model the functionalities of the behavior proposed in preliminary research using reinforcement learning.

By testing this control system in a physics engine and observing behaviors exhibited by them, we find that the preliminary hypotheses are insufficient for reproducing head-bobbing.
